      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-200/80 pb-5 dark:border-slate-800">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white p-2 text-slate-600 hover:bg-slate-50 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
            title="Refresh"
          >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-4 dark:border-slate-800">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="h-9 w-full rounded-xl border border-slate-200 bg-white pl-9 pr-3 text-xs outline-none focus:border-purple-500 dark:border-slate-800 dark:bg-slate-950 text-slate-900 dark:text-white"
            />
          </div>
        </div>
