          ...
          <div className="flex flex-wrap lg:flex-nowrap items-center gap-3">
            ...
            <div className="relative w-full flex-1 min-w-[220px]">
              ...
              <input
                ...
                className="h-9 w-full rounded-xl border border-slate-200 bg-white pl-9 pr-8 text-xs text-slate-900 placeholder:text-slate-400 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/10 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
              />
              {searchQuery && (
                <button
                  type="button"
            ...
            <select
              ...
              className="h-9 w-full sm:w-[220px] lg:w-[220px] shrink-0 truncate rounded-xl border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-700 focus:border-indigo-500 focus:outline-none dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200 cursor-pointer"
            >
            ...
            <select
              ...
              className="h-9 w-full sm:w-[165px] lg:w-[165px] shrink-0 rounded-xl border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-700 focus:border-indigo-500 focus:outline-none dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200 cursor-pointer"
            >
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 hover:bg-slate-50 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white transition-colors"
              >
          ...
          <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-xs font-semibold text-white shadow-md shadow-blue-600/20 hover:bg-blue-700"
              >
...
function StatusBadge({ status }) {
  ...
  return (
    <span
      className={`inline-flex items-center whitespace-nowrap shrink-0 gap-1.5 rounded-full border px-2.5 py-0.5 text-[11px] font-bold ${current.className}`}
    >
