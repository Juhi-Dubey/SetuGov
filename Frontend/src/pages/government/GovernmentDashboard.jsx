      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <span className="inline-flex w-fit items-center rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-semibold text-slate-600 dark:bg-slate-800 dark:text-slate-300">
              Total {total} tracked
            </span>
          </div>
          <p className="mt-1 text-xs text-slate-600">
        ...
        <span className="hidden sm:inline-flex w-fit items-center gap-1.5 rounded-full bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-700 dark:bg-indigo-950/50 dark:text-indigo-300">
...
function EmptyChallenges({ onCreateChallenge }) {
  return (
    <div className="flex flex-col items-center justify-center py-14 sm:py-16 px-4 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-indigo-100 bg-indigo-50 text-indigo-600 shadow-sm dark:border-indigo-900/40 dark:bg-indigo-950/40 dark:text-indigo-400">
      ...
      <p className="mt-1.5 max-w-sm text-xs sm:text-sm text-slate-500 dark:text-slate-400">
        Get started by creating your department's first innovation challenge using the AI Copilot.
      </p>
      <button
        type="button"
