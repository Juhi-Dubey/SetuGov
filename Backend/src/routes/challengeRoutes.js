...
router.get('/:challenge_id/applications', authenticate, getChallengeApplications);
...
// Get Match Scores for a Challenge
router.get('/:challenge_id/matches', authenticate, getChallengeMatches);

// Get Specific Match Score for a Startup
router.get('/:challenge_id/matches/:startup_id', authenticate, getSpecificMatch);

// Get Aggregated Evaluation Summary across all applications in Challenge
router.get('/:challenge_id/evaluation-summary', authenticate, getChallengeEvaluationSummary);

// Get Pilot associated with a Challenge
router.get('/:challenge_id/pilot', authenticate, getChallengePilot);
